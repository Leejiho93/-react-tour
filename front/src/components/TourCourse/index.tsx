...
import { DetailPropsItem, TourCourseProps } from '../../modules/detail';
...
const TourCourse = ({ item }: DetailPropsItem) => {
  useEffect(() => {
    console.log('course info', item.info);
    console.log('course info', item.intro);
  });
      ...
      <Wrapper>
        ...
        <CourseImage>
          <CardWrapper
            ...
            cover={
              imageSrc ? (
                <CardImage src={imageSrc} alt="코스이미지" />
              ) : (
                <ImageReady
                  alt="준비중"
                  src="error"
