...
})(["font-size:50px;font-weight:600;padding:50px 0;text-align:center;", "{width:90%;padding:100px 0 50px;}", "{font-size:40px;}", "{font-size:35px;}", "{font-size:30px;}"], ({
  theme
}) => theme.window.laptop, ({
  theme
}) => theme.window.tablet, ({
...
})(["width:100%;text-align:center;border:1px solid #000;cursor:pointer;padding:5px;font-weight:600;& span{padding:0 3px;font-size:15px;}margin:15px 0;", "{width:90%;}"], ({
  theme
}) => theme.window.laptop);
  ...
  return /*#__PURE__*/(0,jsx_runtime_.jsxs)(jsx_runtime_.Fragment, {
    children: [/*#__PURE__*/(0,jsx_runtime_.jsxs)(DetailItemInfo, {
      children: ["\uCF54\uC2A4 ", /*#__PURE__*/(0,jsx_runtime_.jsxs)("span", {
        children: ["(", item.intro[0].distance, ")"]
      })]
...
})(["width:980px;height:400px;position:relative;", "{}", "{}", "{height:320px;}"], ({
  theme
}) => theme.window.laptop, ({
  theme
}) => theme.window.tablet, ({
...
})(["position:absolute;text-align:center;z-index:99;width:260px;height:140px;background-color:#fff;margin:10px;border-radius:20px;box-shadow:3px 3px 5px 0px rgb(0 0 0 / 20%);padding:10px;& div{margin-bottom:30px;}& span{font-size:18px;font-weight:bold;}& b{background-color:#5b5b5b;padding:5px 10px;margin-top:10px;border-radius:10px;color:#fff;&:hover{font-weight:bold;}& span{font-size:18px;}}", "{width:280px;height:100px;& div{margin-bottom:5px;}& span{font-size:18px;}& b{padding:2px 5px;font-size:15px;}}"], ({
  theme
}) => theme.window.mobileL);
  ...
  (0,external_react_.useEffect)(() => {
    ...
    script.onload = () => {
      window.kakao.maps.load(() => {
        ...
        marker.setMap(map); // const iwContent = `<div style="display:flex;flex-direction:column;justify-content:center;align-items:center;padding:5px;">${title} <br><a href="https://map.kakao.com/link/map/${title},${mapy},${mapx}" style="color:blue" target="_blank">길찾기</a></div>`;
    ...
    children: mapx ? /*#__PURE__*/(0,jsx_runtime_.jsxs)(MapWrapper, {
      children: [/*#__PURE__*/(0,jsx_runtime_.jsxs)(Infowindow, {
        children: [/*#__PURE__*/jsx_runtime_.jsx("div", {
          ...
          href: `https://map.kakao.com/link/to/${filter ? title.replace(filter[0], '') : title},${mapy},${mapx}`,
          target: "_blank",
          rel: "noreferrer",
...
})(["width:100%;border-radius:5px;padding:10px;resize:none;outline:none;"]);
...
// EXTERNAL MODULE: ./src/pages/_app.tsx + 3 modules
var _app = __webpack_require__(6802);
...
var Layout = __webpack_require__(5503);
...
const Detail = ({
  ...
  return /*#__PURE__*/jsx_runtime_.jsx(Layout/* default */.Z, {
    children: /*#__PURE__*/(0,jsx_runtime_.jsxs)(common/* DtailWrapper */.pv, {
...
var __webpack_exports__ = __webpack_require__.X(0, [61,297,525,674,802,503], () => (__webpack_exec__(2924)));
